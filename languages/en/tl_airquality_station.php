 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_airquality_station']['title']       = array('Station title', 'Please enter the station title.');


/**
 * Legends
 */
$GLOBALS['TL_LANG']['tl_airquality_station']['title_legend']      = 'Station title';
