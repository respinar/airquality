 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_airquality_station']['title']       = array('عنوان ایستگاه', 'Please enter the station title.');
 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_airquality_station']['new']    = array('ایستگاه جدید', 'Create a new station');
